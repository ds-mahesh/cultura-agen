      ...
      <div className="site-header">
        <div className="header-top">
          ...
          <div className="flex justify-center">
            <div className="mb-3 xl:w-96" style={{ width: "600px" }}>
              <div className="input-group relative flex  items-stretch w-full mb-4 ">
                <input type="search" className="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-full transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none " placeholder="Search for a book,a game..." aria-label="Search" aria-describedby="button-addon2" />
        ...
        {/* <div className="container">
            <Menu c_digitalBusiness={props._site} />
          </div> */}
