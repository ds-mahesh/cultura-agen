...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
 ...
 return {
   title:`${document.c_meta_title?document.c_meta_title:`Cultura Agen - Infos pratiques Near Me - Find Cultura Agen - Infos pratiques Branch Locator Here.`}`,
   charset: "UTF-8",
   ...
   tags: [
     {
       ...
       attributes: {
         name: "description",
         content: `${document.c_meta_description?document.c_meta_description:`View Cultura Agen - Infos pratiques near you today at Cultura Agen - Infos pratiques. We stock high-quality, robust products at competitive rates.`}`,
       },
     },
     ...
     },
     {
       ...
       attributes: {
         property: "og:title",
         content: `${document.c_meta_title?document.c_meta_title:`Cultura Agen - Infos pratiques Near Me - Find Cultura Agen - Infos pratiques Branch Locator Here.`}`,
       },
     },
     {
       type: "meta",
